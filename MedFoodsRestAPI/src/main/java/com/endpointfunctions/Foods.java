...
public class Foods {
	...
	// To be completed
	public static JSONObject getFoodData(Connection c, String foodId) {
	...
	public static JSONObject getActiveIngredients(Connection c, String foodId, JSONObject response) {
		try {
			PreparedStatement ps = c
	...
	public static JSONObject getMetabolites(Connection c, String foodId, JSONObject response) {
		try {
	...
	public static JSONObject getRecommendationData(Connection c, String foodId, JSONObject response) {
		try {
			...
			ResultSet rs = ps.executeQuery();
			if (rs.next()) {
				response.put("recommendationId", rs.getInt(2));
				...
				response = getRecommendationReferences(c, rs.getInt(2), response);
